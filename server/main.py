...
from Generators import (
    ...
    SimpleMessageWithFullNameGenerator,
    ElderPictureMessageGenerator,
    TailerMadeMessageGenerator,
)
...
def greetings_v4():
    ...
    generator = TailerMadeMessageGenerator(
        discount_for_male, items_for_male, discount_for_female, items_for_female
    )
    repo = get_repo(db_type)
    service = BirthdayService(repo, generator)
    greetings = service.send_greetings(date_obj, output_type)
